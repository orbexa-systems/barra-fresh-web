    ...
    <div>
      ...
      <div className="flex flex-wrap justify-center gap-3 mb-10">
        <button
          ...
          className={`px-5 py-2 rounded-full text-sm font-semibold transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 ${
            activeCategory === 'all'
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredProducts.map((product) => (
          ...
          >
            ...
            <div className="p-5">
              <h3 className="font-bold text-gray-900 text-lg mb-1 group-hover:text-green-600 transition-colors duration-200">
                {product.name}
              </h3>
              ...
              <div className="flex items-center justify-between">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-green-600 hover:bg-green-700 text-white text-sm font-semibold transition-all duration-200 shadow-sm hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2"
      ...
      <div className="text-center mt-12">
        <a
          href={buildWhatsAppUrl('Hola, quiero hacer un pedido de BarraFresh. ¿Me pueden apoyar?')}
          target="_blank"
          rel="noopener noreferrer"
